...
if (LibOPENFAM_FOUND)
  ...
  find_library(LIB_OPENFAM_RESMGR_LIBRARY
    NAMES famresmgr
    HINTS
      ${OPENFAM_DIR}
      ${OPENFAM_PATH}
  ...
  find_library(LIB_OPENFAM_COMMON_LIBRARY
    NAMES famcommon
    HINTS
      ${OPENFAM_DIR}
      ${OPENFAM_PATH}
    ...
    if(LIB_OPENFAM_RESMGR_LIBRARY)
      set_property(TARGET LibOPENFAM APPEND PROPERTY
             INTERFACE_LINK_LIBRARIES "${LIB_OPENFAM_RESMGR_LIBRARY}")
    endif()
    if(LIB_OPENFAM_COMMON_LIBRARY)
      set_property(TARGET LibOPENFAM APPEND PROPERTY
             INTERFACE_LINK_LIBRARIES "${LIB_OPENFAM_COMMON_LIBRARY}")
    endif()
    endif()
endif()

mark_as_advanced(LIB_OPENFAM_INCLUDE_DIR LIB_OPENFAM_LIBRARY LIB_OPENFAM_RESMGR_LIBRARY
                 LIB_OPENFAM_COMMON_LIBRARY)
