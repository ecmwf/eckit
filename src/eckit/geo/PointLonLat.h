...
public:
    ...
    [[nodiscard]] static PointLonLat make_from_spec(const Spec&, const std::string& name);
    [[nodiscard]] static PointLonLat make_from_spec(const Spec&, const std::string& name, const PointLonLat& dfault);
