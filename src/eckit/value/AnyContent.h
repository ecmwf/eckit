...
protected:
    ...
    AnyContent(const string&);
    AnyContent(const char*);
    AnyContent(Stream&);
    ...
    virtual int  compareString(const AnyContent&)        const;
    ...
    virtual Content* addString(const AnyContent&) const;
...
private:
    ...
    AnyContent(const AnyContent&);
    AnyContent& operator=(const AnyContent&);
    ...
    static  Reanimator<AnyContent>  reanimator_;

    // -- Friends

    friend class Reanimator<AnyContent>;
    friend class Value;
};
