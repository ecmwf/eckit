...
protected:
    ...
    int compareOrderedMap(const OrderedMapContent&) const override;
    ...
    std::string typeName() const override { return "OrderedMap"; }

    bool isMap() const override { return true; }
    bool isOrderedMap() const override { return true; }
