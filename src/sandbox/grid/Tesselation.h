...
public:
    ...
    static std::vector< KPoint3 >* generate_latlon_points( const size_t& nlats, const size_t& nlong );

    /// generate regular lat-long grid points (includes extremes -90,90 and 0,360)
    static std::vector< KPoint3 >* generate_latlon_grid( const size_t& nlats, const size_t& nlong );
