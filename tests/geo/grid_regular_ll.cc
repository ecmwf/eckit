...
CASE("arakawa c-grids") {
    SECTION("properties") {
        ...
        for (const auto& test : {
                 ...
                 test_t{96, {144, 192}, {1.875, 1.25}},
                 test_t{144, {216, 288}, {1.25, 0.833333333333333}},
                 test_t{216, {324, 432}, {0.833333333333333, 0.555555555555556}},
                 test_t{320, {480, 640}, {0.5625, 0.375}},
                 test_t{400, {600, 800}, {0.45, 0.3}},
                 test_t{512, {768, 1024}, {0.3515625, 0.234375}},
                 test_t{640, {960, 1280}, {0.28125, 0.1875}},
                 test_t{768, {1152, 1536}, {0.234375, 0.15625}},
                 test_t{1280, {1920, 2560}, {0.140625, 0.09375}},
             }) {
