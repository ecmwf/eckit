...
CASE("test_eckit_utils_md4_test_suite_from_rfc1320") {
    ...
    EXPECT(MD4("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789").digest() ==
           std::string("043f8582f241db351ce627e153e7f0e4"));
    EXPECT(MD4("12345678901234567890123456789012345678901234567890123456789012345678901234567890").digest() ==
           std::string("e33b4ddc9c38f2199c3e7b164fcc0536"));
}
